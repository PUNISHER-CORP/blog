...
class  Admin extends Model
{
    ...
    public function postValidate($post, $type)
    {
        ...
        if($nameLen < 5 or $nameLen > 100){
            $this->error = 'Название должно содержать от 5 до 100 символов!';
            return false;

        } elseif($descriptionLen < 10 or $nameLen > 100){
            $this->error = 'Описание должно содержать от 10 до 100 символов!';
            return false;
        } elseif($textLen < 10 or $nameLen > 5000){
